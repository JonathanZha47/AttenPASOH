...
from Model.Compare_Models.Autoformer.Informer import Informer
import os
...
class InformerNet(nn.Module):
    def __init__(self,args):
        super(InformerNet, self).__init__()
        self.args = args
        ...
        self.Informer = Informer(args).to(device)
        self.loss_func = nn.MSELoss()
        self.relu = nn.ReLU()
        self.optimizer = torch.optim.Adam(self.Informer.parameters(),lr=0.001)
    ...
    def Train(self,trainloader,testloader=None,validloader=None):
        ...
        for e in range(1,self.args.epochs+1):
            ...
            if valid_mse < min_valid_mse and testloader is not None:
                ...
                ############################### save ############################################
                self.best_model = {'Informer':self.Informer.state_dict()}
