...
class GRUNet(nn.Module):
    def __init__(self,args):
        ...
        self.gru = GRU(input_size = 17, hidden_size = 50, output_size=1).to(device)
        self.loss_func = nn.MSELoss()
        self.relu = nn.ReLU()
        self.optimizer = torch.optim.Adam(self.gru.parameters(),lr=0.001)
    ...
    def Train(self,trainloader,testloader=None,validloader=None):
        ...
        for e in range(1,self.args.epochs+1):
            ...
            if valid_mse < min_valid_mse and testloader is not None:
                ...
                ############################### save ############################################
                self.best_model = {'gru':self.gru.state_dict()}
