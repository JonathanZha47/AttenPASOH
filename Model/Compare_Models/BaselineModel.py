"""
    In this file, this is the baseline model which is PINN4SOH from Wang et al. 2024 Nature Communication.

    The model is using modules as below:
    - Sin: the sin activation function
    - MLP: the multi-layer perceptron
    - LRscheduler
    - DynamicF: for the dynamic PDE for battery degradation
    - Loss Data, Loss PDE, and Loss Physics
"""
