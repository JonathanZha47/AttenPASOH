...
from Model.Compare_Models.CrossFormer.crossformer import Crossformer
import os
device = 'cuda' if torch.cuda.is_available() else 'cpu'
from utils.util import AverageMeter,get_logger,eval_metrix
import numpy as np

class CrossformerNet(nn.Module):
    def __init__(self,args):
        super(CrossformerNet, self).__init__()
        self.args = args
        ...
        self.crossformer = Crossformer(data_dim = args.data_dim,
        ...
        self.relu = nn.ReLU()
        self.optimizer = torch.optim.Adam(self.crossformer.parameters(),lr=0.001)
    ...
    def load_model(self, model_path):
        ...
        self.crossformer.load_state_dict(checkpoint['crossformer'])
        for param in self.crossformer.parameters():
            param.requires_grad = True
    
    def predict(self,xt):
        return self.crossformer(xt)
    ...
    def Train(self,trainloader,testloader=None,validloader=None):
        ...
        for e in range(1,self.args.epochs+1):
            ...
            if valid_mse < min_valid_mse and testloader is not None:
                ...
                ############################### save ############################################
                self.best_model = {'crossformer':self.crossformer.state_dict()}
...
if __name__ == "__main__":
    ...
    def get_args():
        ...
        parser.add_argument('--data_dim', type=int, default=18, help='Number of dimensions of the MTS data (D)')
        parser.add_argument('--d_model', type=int, default=64, help='dimension of hidden states (d_model)')
