"""
    In this file, it mainly used weight optimization to optimize the intial weight for the loss item in the function.

    Also, it removes the physical loss in the baseline model. 

    So it can be part of the ablation study.
"""
