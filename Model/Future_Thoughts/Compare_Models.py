...
from Model.CompareModels.BaselineModel import MLP as Encoder
from Model.CompareModels.BaselineModel import Predictor
...
class MLP(nn.Module):
    def __init__(self):
        ...
        self.encoder = Encoder(input_dim=49, output_dim=32, layers_num=3, hidden_dim=60, droupout=0.2)
