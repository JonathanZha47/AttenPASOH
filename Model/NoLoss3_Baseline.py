"""
    In this file, it removes the physical loss from the baseline model to see the effect of the physical loss.

    To justify our proof that the physical loss is actually a burden during the training.
"""
...
class NoMonoPINN(nn.Module):
    def __init__(self,args):
        super(NoMonoPINN, self).__init__()
        self.args = args
        ...
        # loss = alpha * data loss + beta * PDE loss
...
if __name__ == "__main__":
    ...
    def get_args():
        ...
        parser.add_argument('--alpha', type=float, default=1, help='loss = data loss + alpha * PDE loss')
