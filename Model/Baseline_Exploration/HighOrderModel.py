...
class HighOrderPINN(nn.Module):
    def __init__(self,args):
        super(HighOrderPINN, self).__init__()
        self.args = args
        ...
        self.dynamical_F = MLP(input_dim=52,output_dim=1,
    ...
    def Train(self,trainloader,testloader=None,validloader=None):
        ...
        for e in range(1,self.args.epochs+1):
            ...
            if valid_mse < min_valid_mse and testloader is not None:
                ...
                [MAE, MAPE, MSE, RMSE,Rsquare] = eval_metrix(pred_label, true_label)
                info = '[Test] MSE: {:.8f}, MAE: {:.6f}, MAPE: {:.6f}, RMSE: {:.6f}, Rsquare: {:.6f}'.format(MSE, MAE, MAPE, RMSE,Rsquare)
                self.logger.info(info)
                early_stop = 0
