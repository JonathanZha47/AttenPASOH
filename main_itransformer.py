...
from Model.Compare_Models.itransformerModel import itransformer
import argparse
import os
...
def main():
    ...
    for i in range(6):
        ...
        for e in range(10):
            save_folder = 'results of reviewer/XJTU(itransformer test) results/' + str(i) + '-' + str(i) + '/Experiment' + str(e + 1)
            ...
            itrans = itransformer(args)
            itrans.Train(trainloader=dataloader['train'],validloader=dataloader['valid'],testloader=dataloader['test'])
