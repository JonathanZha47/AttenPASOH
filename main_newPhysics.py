...
from Model.AttenPredict_newPhysicsLoss import NewPhysicsPINN
import argparse
import os
import sys
import torch
...
def main():
    ...
    for i in range(4,5):
        ...
        for e in range(10):
            save_folder = 'results of reviewer/XJTU-attenPASOH(newPhysics+25weight) results4/' + str(i) + '-' + str(
