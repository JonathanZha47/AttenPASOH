from dataloader.featurewiseloader import *
from Model.AttenFeatureWisePI import FeatureWiseAttenPINN
from Model.CompareModels.Baseline4NASA import PINN
import argparse
import os
import sys
...
def main():
    ...
    for i in range(8):
        ...
        for e in range(10):
            save_folder = 'results of reviewer/NASA-Baseline(test1) results/' + str(i) + '-' + str(i) + '/Experiment' + str(e + 1)
            ...
            pinn = FeatureWiseAttenPINN(args)
...
def get_args():
    ...
    # data loader related
    parser.add_argument('--seq_length', type=int, default=1, help='seq_length')
