...
from Model.Compare_Models.AutoformerModel import AutoformerNet
import argparse
import os
...
def main():
    ...
    for i in range(6):
        ...
        for e in range(10):
            save_folder = 'results of reviewer/XJTU(Autoformer) results/' + str(i) + '-' + str(i) + '/Experiment' + str(e + 1)
            ...
            Autoformer = AutoformerNet(args)
            Autoformer.Train(trainloader=dataloader['train'],validloader=dataloader['valid'],testloader=dataloader['test'])
