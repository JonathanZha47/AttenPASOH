...
from Model.Compare_Models.GRUmodel import GRUNet
import argparse
import os
...
def main():
    ...
    for i in range(6):
        ...
        for e in range(10):
            save_folder = 'results of reviewer/XJTU(GRU) results/' + str(i) + '-' + str(i) + '/Experiment' + str(e + 1)
            ...
            gru = GRUNet(args)
            gru.Train(trainloader=dataloader['train'],validloader=dataloader['valid'],testloader=dataloader['test'])
