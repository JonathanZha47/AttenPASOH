...
from Model.Compare_Models.crossformerModel import CrossformerNet
import argparse
import os
...
def main():
    ...
    for i in range(6):
        ...
        for e in range(10):
            save_folder = 'results of reviewer/XJTU(crossformer) results/' + str(i) + '-' + str(i) + '/Experiment' + str(e + 1)
            ...
            cross = CrossformerNet(args)
            cross.Train(trainloader=dataloader['train'],validloader=dataloader['valid'],testloader=dataloader['test'])
